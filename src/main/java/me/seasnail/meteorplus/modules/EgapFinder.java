...
public class EgapFinder extends Module {
    ...
    public EgapFinder() {
        super(MeteorPlus.CATEGORY, "egap-finder", "Finds Egaps in a SP world and creates a file called \"egap-coords.txt\".");
    }
        ...
        if (!lock) {
            ...
            switch (stage) {
                ...
                case 4: {
                    ...
                    } else mc.player.sendChatMessage("/setblock " + chest.getX() + " " + chest.getY() + " " + chest.getZ() + " minecraft:air");
                    // TODO: Fix -> mc.world.blockEntities.clear();
                    stage++;
                    break;
                }
            }
